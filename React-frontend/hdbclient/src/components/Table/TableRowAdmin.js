...
export class TableRowAdmin extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <tr>
                ...
                <td><button className="btn btn-outline-primary ml-2 my-2 my-sm-0" onClick={(e) => {
                    e.preventDefault();
                    console.log("click on row " + this.props.resalehdbid);
                    window.location.href = "/Edit/" + this.props.resalehdbid;
                }}>Edit</button></td>
                <td><button className="btn btn-outline-primary ml-2 my-2 my-sm-0" onClick={this.onDelete}>Delete</button></td>
                <td><button className="btn btn-outline-primary ml-2 my-2 my-sm-0" onClick={(e) => {
                    e.preventDefault();
